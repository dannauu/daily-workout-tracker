...
const Deadlift = () => {
    ...
    useEffect(() => {
        const storedItems = localStorage.getItem('Deadlift') || [];
    ...
    return (
        <div className='p-2 h-96 bg-contain bg-no-repeat font-semibold slide-in-elliptic-bottom-bck' style={{ backgroundImage: `url(${DeadliftImg})` }}>
